...
namespace CashFlow.Application.UseCases.Expenses.Reports.Pdf
{
    public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
    {
        ...
        public async Task<byte[]> Execute(DateOnly month)
        {
            ...
            // criação das tabelas de cada despesa
            foreach (var expense in expenses) 
            {
                ...
                {
                    AddDescriptionRow(table, row.Cells[3], expense.Description);
                }
        ...
        private Document CreateDocument(DateOnly month)
        {
            ...
            document.Info.Author = "Yuri Fabio Sanches";
        ...
        private void CreateHeaderWithProfilePhotoAndName(Section page)
        {
            ...
            row.Cells[1].AddParagraph("Hey, Yuri Fabio Sanches");
        ...
        {
            cell.AddParagraph($"- {expenseAmount} $");
        ...
        private void AddDescriptionRow(Table table, Cell cell, string expenseDescription)
        {
